    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.client')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='base.question')),
        ...
        migrations.AddField(
            model_name='question',
            name='technology',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.technology'),
        ),
        migrations.CreateModel(
            name='Interviewee',
            fields=[
                ...
                ('category_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.category')),
        ...
        migrations.AddField(
            model_name='client',
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='base.mentor'),
        ),
        migrations.AddField(
            model_name='client',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Selected', 'Selected'), ('Rejected', 'Rejected'), ('Waiting for feedback', 'Waiting for feedback'), ('Waiting for Kickstart', 'Waiting for Kickstart'), ('Waiting for schedule', 'Waiting for schedule'), ('Assigned', 'Assigned')], max_length=255)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.client')),
